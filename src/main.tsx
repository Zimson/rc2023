...
const jsxRroot = ReactDOM.createRoot(
  document.getElementById('jsx-root') as Element,
);
    ...
    children: [
      ...
      React.createElement('li', {
        ...
        children: [
          ...
          React.createElement('h3', {
            key: `menu-subtitle-${restaurants[0].id}`,
            children: 'Меню:',
          }),
          ...
          React.createElement('h3', {
            key: `reviews-subtitle-${restaurants[0].id}`,
            children: 'Отзывы:',
          }),
      ...
      React.createElement('li', {
        ...
        children: [
          ...
          React.createElement('h3', {
            key: `menu-subtitle-${restaurants[1].id}`,
            children: 'Меню:',
          }),
          ...
          React.createElement('h3', {
            key: `reviews-subtitle-${restaurants[1].id}`,
            children: 'Отзывы:',
          }),
      ...
      React.createElement('li', {
        ...
        children: [
          ...
          React.createElement('h3', {
            key: `menu-subtitle-${restaurants[2].id}`,
            children: 'Меню:',
          }),
          ...
          React.createElement('h3', {
            key: `reviews-subtitle-${restaurants[2].id}`,
            children: 'Отзывы:',
          }),
      ...
      React.createElement('li', {
        ...
        children: [
          ...
          React.createElement('h3', {
            key: `menu-subtitle-${restaurants[3].id}`,
            children: 'Меню:',
          }),
          ...
          React.createElement('h3', {
            key: `reviews-subtitle-${restaurants[3].id}`,
            children: 'Отзывы:',
          }),
